      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <div className="bg-gray-900 p-4 rounded-lg">
            <p className="text-gray-400 text-sm italic">(Image placeholder: Personas)</p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="bg-gray-900 p-4 rounded-lg">
            <p className="text-gray-400 text-sm italic">(Image placeholder: Competitive analysis)</p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="bg-gray-900 p-4 rounded-lg">
            <p className="text-gray-400 text-sm italic">(Image placeholder: Sitemap)</p>
          </div>
        </div>
      </div>
    );
    ...
    return (
      <div className="space-y-6">
        ...
        <div>
          ...
          <div className="bg-gray-900 p-4 rounded-lg">
            <p className="text-gray-400 text-sm italic">(Image placeholder: Low fidelity wireframes)</p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="bg-gray-900 p-4 rounded-lg">
            <p className="text-gray-400 text-sm italic">(Image placeholder: High fidelity wireframes)</p>
          </div>
        </div>
      </div>
    );
